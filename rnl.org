...
*** Generic ALists <<ilink3>>
    #+begin_src java :classname 
      public class AList<Glorp> {
          ...
          public void resize(int capacity) {
              Glorp[] a = (Glorp []) new Object[capacity]; <<elinktemp1>>
              System.arraycopy(items, 0, a, 0, size);
              items = a;
          }
...
*** Comparator
    ...
    #+begin_src java :classname 
      ...
      public class Dog implements Comparable<Dog> { <<elinktemp2>>
          ...
          public int compareTo(Dog uddaDog) {
              return this.size - uddaDog.size;
          }
    ...
    - About nexted ~private static class NameComparator implements Comparator<Dog>~ <<ilink2>>
...
*** Question:                                                     :QUESTIONS:
    1. 怎样理解 [[ilink1]] Comparable 和 Comparator 的区别？分析的对吗？
    2. [[ilink2]] 中关于 nested 原因的分析对吗？为什么 Comparator 一定要是 Object？如下可以吗？
       #+begin_src java :classname 
         import java.util.Comparator;
...
**** Question:                                                    :QUESTIONS:
     - [ ] 怎么理解 Graph Problems 中 s-t shortest paths 的时间复杂度分析？为什么和 s-t paths 一样？
*** Graph Problems
    - Adjacency matrix
...
**** Question:                                                    :QUESTIONS:
     - [ ] 上图中的 ~changePriority~ 是什么功能？复杂度怎么分析？
     - [ ] Overall runtime 怎么分析出来的？
** A*
   Visit vertices in order of $d(Denver, v) + h(v, goal)$, where $h(v, goal)$ is an *estimate* of the distance from $v$ to $goal$.
...
* L29 Basic Sorts
* L30 Quick Sort
* L31 Software Engineering I
* L32 More Quick Sort, Sorting Summary
* L33 Sorting and Algorithmic Bounds
* L34 Software Engineering II
* L35 Radix Sorts
* L36 Sorting and Data Structures Conclusion
* L37 Software Engineering III
* L38 Compression
* L39 Compression, Complexity, and P=NP?
* L40 Summary, Fun
